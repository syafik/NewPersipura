...
public class Store extends SherlockFragment {
	...
	List<StoreBean> listThisWeekBean;
...
//		new fetchFooterFromServer().execute("");
		...
		View rootView = inflater.inflate(R.layout.stores, container, false);
	...
	private class fetchLocationFromServer extends
		...
		protected String doInBackground(Integer... param) {
			String result = WebHTTPMethodClass.httpGetService(
					"/restapi/get/store", "limit=" + param[0] + "&offset="
							+ param[1]);
		...
		protected void onPostExecute(String result) {
			try {
				...
				listThisWeekBean = new ArrayList<StoreBean>();
				for (int i = 0; i < jsonArray.length(); i++) {
					JSONObject resObject = jsonArray.getJSONObject(i);
					StoreBean thisWeekBean = new StoreBean();
					thisWeekBean.setname(resObject.getString("name"));
					thisWeekBean.setaddress(resObject.getString("address"));
					thisWeekBean.setlogo(resObject.getString("logo"));
					thisWeekBean.setphone(resObject.getString("phone"));
		...
		private void createSelectLocationListView(
				List<StoreBean> listThisWeekBean) throws IOException {
			for (int i = 0; i < listThisWeekBean.size(); i++) {
				StoreBean thisWeekBean = listThisWeekBean.get(i);
				View cellViewMainLayout = mInflater.inflate(R.layout.store_list,
						null);
				...
				TextView phoneTextView = (TextView) cellViewMainLayout
						.findViewById(R.id.findzoes_list_text_phone);
				ImageView imgNews = (ImageView) cellViewMainLayout
						.findViewById(R.id.imageView1);

				titleNews.setText(thisWeekBean.getname());
				descNews.setText(Html.fromHtml(thisWeekBean.getaddress()));
				phoneTextView.setText(Html.fromHtml(thisWeekBean.getphone()));
				...
				imgLoader.DisplayImage(thisWeekBean.getlogo(), loader,
						imgNews);
